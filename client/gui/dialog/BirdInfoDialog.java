...
public class BirdInfoDialog extends JDialog implements ActionListener{
	...
	public BirdInfoDialog(SelectWindow selectWindow) {
		super(selectWindow, "참새맨 정보", true);		//true이면 다이얼로그 처리 꼭 해야함. false이면 안해도 다른 창 사용 가능 ( modal )
		setSize(486,312);
		...
		ta_patch.setText( "이름 : 참새맨\n\n"
						+ "라이프 : 5\n"
						+ "특징 : 좌우방향모션있음(무쓸모)\n"
						+ "특수능력(Space Bar)\n"
						+ ": 약 3초간 피격되지 않음.(총 2회)\n\n"
						+ "참새맨> 나는 참새가 아니다. 날아다니는 닭이다!!");
