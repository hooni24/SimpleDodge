		...
		try {
			while(isOn){
				for(int i = 1; i < 8; i ++){						//isOn이 true인 동안. (즉 날아가는 동안) 지속적으로 repaint 함으로 애니메이션 효과
					...
					repaint();
					Thread.sleep(17);								//애니메이션 재생 속도 조절.
